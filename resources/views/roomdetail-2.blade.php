    ...
    <div class="container">
        <section class="room-details">
            <div class="room-image">
                <img src="./img/twinbedroom.jpg" alt="ภาพห้อง">
        ...
        <div class="room-info">
            ...
            <section class="booking">
                ...
                @endforeach
                <a href="{{ route('selectbook', ['bedType' => 'twin']) }}" class="btn">จองห้อง</a>
            </section>
    </div>
</body>
</html>
